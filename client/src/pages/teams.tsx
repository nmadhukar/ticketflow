    ...
    <div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 flex flex-col">
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Create a new team to collaborate with other members on tasks and projects.
                  </DialogDescription>
                </DialogHeader>
        ...
        <main className="flex-1 p-6 overflow-y-auto">
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-slate-500 mb-4">
                    You're not a member of any teams. Create a team or ask to be invited to one.
                  </p>
                  <Button 
          ...
          {/* All Teams Section */}
          <div>
            <h3 className="text-lg font-semibold text-slate-800 mb-4">All Teams</h3>
            {teamsLoading ? (
